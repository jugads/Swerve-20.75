...
public class RobotContainer {
  ...
  private double MaxAngularRate = MaxSpeed * 3;/// (20.75 * Math.PI * 0.0254); // 3/4 of a rotation per second max angular velocity
  ...
  SwerveRequest.RobotCentric driveRobotRelative = new SwerveRequest.RobotCentric()
      .withDeadband(MaxSpeed * 0.1).withRotationalDeadband(MaxAngularRate * 0.1) // Add a 10% deadband
